...
/* 🔴 **הוארך 26.08 — דביר: "לוקח הרבה זמן לעכל תשלום דרך SUMIT".**

   שלושה ניסיונות עם 2.5 שניות ביניהם נותנים ל-SUMIT **פחות מ-8
   שניות** לסיים לעבד. כשזה לוקח לה יותר, הלקוח נוחת במצב "pending"
   ורואה "אל תשלם שוב, כתוב לי" — על תשלום שעבר בהצלחה. זו החוויה
   הגרועה ביותר שיש: הוא בטוח שמשהו נשבר.

   ⚠️ **ההשהיה עולה בהדרגה** ולא קבועה: אם התשובה מגיעה מהר, הלקוח
   לא חיכה לחינם; אם היא איטית, אנחנו נותנים לה זמן אמיתי במקום
   להתייאש. סה"כ סבלנות: ~40 שניות המתנה בין ניסיונות, ועוד זמן
   התשובות עצמן.
...
async function runVerification(){
  ...
  for(let attempt = 1; attempt <= MAX_ATTEMPTS; attempt++){
    ...
    if(attempt < MAX_ATTEMPTS){
      await sleep(RETRY_DELAYS_MS[attempt - 1] || 12000);
    }
  }
