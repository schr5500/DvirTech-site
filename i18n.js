...
const UI_TEXT = {
  he: {
    ...
    installmentsHint:"עד 3 תשלומים ללא עמלה נוספת. מ-4 תשלומים ומעלה מתווספת עמלת תשלומים, מפורטת למטה לפני התשלום.",
    ...
    aboutAreaText:"אנחנו נותנים שירות באר שבע והסביבה, אזור המרכז והשפלה. הרכבות, ייעוץ ורכישת מוצרים אפשריים גם מרחוק עם משלוח עד הבית; ביקורי בית מתואמים מראש בהתאם לאזור ולזמינות.",
    ...
    contactAreaLabel:"אזור שירות", contactAreaText:"באר שבע והסביבה · מרכז · שפלה",
  ...
  en: {
    ...
    installmentsHint:"Up to 3 payments with no extra fee. From 4 payments and up, an installment fee is added, itemized below before payment.",
    ...
    aboutAreaText:"We serve Beer Sheva and the surrounding area, the Center, and the Shfela region. Builds, consultations and product purchases are also available remotely with delivery; home visits are scheduled in advance based on location and availability.",
    ...
    contactAreaLabel:"Service area", contactAreaText:"Beer Sheva & surrounding area · Center · Shfela",
