...
const UI_TEXT = {
  he: {
    ...
    installmentsHint:"עד 2 תשלומים ללא עמלה נוספת. מ-3 תשלומים ומעלה מתווספת עמלת תשלומים, מפורטת למטה לפני התשלום.",
  ...
  en: {
    ...
    installmentsHint:"Up to 2 payments with no extra fee. From 3 payments and up, an installment fee is added, itemized below before payment.",
