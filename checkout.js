...
/*
   ...
   1-3 תשלומים: אפס. מ-4 ומעלה: 0.75% × **כל** התשלומים + מע"מ.
   12 תשלומים = 10.62%.

   ⚠️ **הגרסה הקודמת גבתה (n−3) כדי לרכך את המדרגה בתשלום הרביעי,
   ודביר החליט לחזור.** הנימוק שלו: שלושה תשלומים ללא עמלה הם כבר
   הטבה אמיתית — הוא סופג עליהם 219 ₪ בעסקה של 5,000 ₪ — ותשלומים
   הם בחירה, לא תנאי לרכישה. מי שלא רוצה עמלה משלם עד 3.
   ...
   **כל הסכום שעבר בכרטיס**, כולל שורת העמלה עצמה — ולכן על 5,000 ₪
   ...
   ⚠️ **המחיר: מדרגה בתשלום הרביעי.** על 5,000 ₪ — 0 ₪ בשלושה
   תשלומים מול 177 ₪ בארבעה. זו החלטה מודעת, לא באג. הריכוך הוא
   בממשק ולא בנוסחה: עמוד התשלום חייב לסמן "עד 3 תשלומים — ללא
   עמלה" **לפני** שהלקוח בוחר, כדי שהמדרגה תהיה שלט ולא הפתעה.
...
/* ==================== תוויות אפשרויות התשלומים ====================
   ...
   **אחרי** הבחירה. לקוח שכבר החליט "ארבעה תשלומים" וגילה 177 ₪
   ...
   עכשיו כל שורה נושאת את המחיר שלה, ו"עד 3 — ללא עמלה" יושב מול
   "4 — ‎+177 ₪" באותה רשימה. הלקוח בוחר בעיניים פקוחות, ורובו
   ייבחר 3 — התרחיש הרווחי ביותר לדביר ממילא.
