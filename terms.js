  ...
  he: [
    ...
    },
    {
      ...
      html: `<!-- טיוטה 27.08 — לאישור עו"ד: סעיפי 6.1-6.2, 6.4-6.5 עודכנו; 6.6-6.9 חדשים/מוספרו מחדש -->
             ...
             <p><b>6.8 מחירון דו-שכבתי לשירותים.</b> לשירותי בית העסק שני מחירים: "מחיר טכנאי" — לכל לקוח, ו"מחיר DvirTech" — מחיר מוזל ללקוח שרכש מבית העסק מוצרים בסכום מצטבר של 1,000 ₪ ומעלה ב-12 החודשים שקדמו להזמנת השירות. הזכאות נבחנת לפי רישומי בית העסק. מחיר הטכנאי הוא מחיר אמיתי הנגבה בפועל מלקוחות שאינם זכאים למחיר המוזל, והצגתו לצד המחיר המוזל היא הצגת מחירו הרגיל של השירות. ההטבה היא מדיניות מסחרית של בית העסק וניתנת לעדכון; שינוי יחול על הזמנות חדשות בלבד.</p>
