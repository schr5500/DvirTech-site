  ...
  he: [
    ...
    },
    {
      ...
      html: `<p><b>5.1 משלוח.</b> המשלוח מתבצע באמצעות <b>חברת שילוח חיצונית</b>, בשתי אפשרויות הנבחרות בעמוד התשלום: <b>משלוח רגיל — 29 ₪, טווח משוער 3-7 ימי עסקים</b>; <b>משלוח מהיר — 49 ₪, טווח משוער 2-5 ימי עסקים</b>. המחיר וזמן האספקה המוצגים בעמוד התשלום במועד ביצוע ההזמנה הם המחייבים.</p>
             ...
             <p><b>5.2 מתי מתחילה הספירה.</b> ספירת ימי האספקה מתחילה לאחר שההזמנה אושרה, התשלום הוסדר והמוצר זמין למשלוח — ולא בהכרח מרגע לחיצת ההזמנה. <b>הימים נספרים בימי עסקים</b>, ואינם כוללים שבתות, חגים וימי שבתון. הזמנות הכוללות רכיבים שיש להזמין מספק תלויות בזמינות אצל הספק, והערכת זמן תימסר ללקוח מראש ככל הידוע.</p>
