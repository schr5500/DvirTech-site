/* =====================================================================
   ...
   **התקנון מתאר את מה שהמערכת באמת עושה — לא את מה שנחמד להבטיח.**
   ...
   נגזרה מקובץ אמיתי, ואלה המקורות:
     ...
     • משלוח 35/49/0 ₪ + זמנים ................. checkout.js:229-238
...
const LEGAL_TODO_HE = '<span class="legal-todo">⚠️ לאישור עו״ד</span>';
const LEGAL_TODO_EN = '<span class="legal-todo">⚠️ pending legal review</span>';
  ...
  he: [
    {
      ...
      html: `<p>אתר זה (״האתר״) מופעל על ידי <b>דביר פרץ</b>, <b>עוסק פטור</b>, מס׳ עוסק 322999582 (״DvirTech״ או ״בית העסק״).</p>
             <p>בית העסק הוא עסק מקוון ו<b>אינו מפעיל חנות פיזית הפתוחה לקהל</b>. איסוף עצמי אפשרי מ<b>אבן שמואל</b>, בתיאום מראש בלבד. ביקורי טכנאי מתבצעים באזור באר שבע והסביבה, המרכז והשפלה, בתיאום מועד מראש.</p>
             ...
             <p>הוראות חוק הגנת הצרכן חלות על ״צרכן״ כהגדרתו בחוק. רכישה שנעשית לצורכי עסק עשויה שלא להיות מוגנת באותו אופן. ${LEGAL_TODO_HE}</p>`
    },
    {
    ...
    },
    {
      ...
      html: `<p>בית העסק הוא <b>עוסק פטור</b> ואינו גובה מהלקוח מע״מ בנפרד. המחירים המוצגים באתר הם המחירים שהלקוח נדרש לשלם, אלא אם צוין אחרת במפורש.</p>
    ...
    },
    {
      ...
      html: `<p><b>סליקה חיצונית מאובטחת.</b> התשלום אינו מתבצע באתר עצמו. עם אישור ההזמנה מופנה הלקוח ל<b>דף סליקה מאובטח חיצוני</b> המופעל על ידי חברת הסליקה (SUMIT/UPAY). <b>פרטי כרטיס האשראי אינם עוברים דרך האתר, אינם נראים לבית העסק ואינם נשמרים אצלו</b> — הם מוזנים ומעובדים מול חברת הסליקה בלבד.</p>
             ...
             <p><b>4 תשלומים ומעלה — עמלת תשלומים.</b> בחירה ב-4 תשלומים ומעלה היא בחירה אופציונלית של הלקוח, וכרוכה בעמלה המשקפת את עלות המימון בפועל. העמלה מחושבת <b>לכל חודש תשלום</b> (ולכן 6 תשלומים עולים יותר מ-4), ומוצגת ללקוח <b>בסכום שקלי מדויק, יחד עם הסכום הכולל לתשלום, לפני</b> אישור העסקה — ולא לאחריו.</p>
             <p><b>לא ייגבה מהלקוח סכום שלא הוצג לו על המסך לפני אישור העסקה.</b></p>
    ...
    },
    {
      ...
      html: `<p><b>5.1 משלוח.</b> המשלוח מתבצע באמצעות שירות שליחויות חיצוני, בשתי אפשרויות הנבחרות בעמוד התשלום: <b>משלוח רגיל — 35 ₪, טווח משוער 3-7 ימי עסקים</b>; <b>משלוח מהיר — 49 ₪, טווח משוער 2-5 ימי עסקים</b>. המחיר וזמן האספקה המוצגים בעמוד התשלום במועד ביצוע ההזמנה הם המחייבים. זהות חברת השילוח תפורסם באתר. ${LEGAL_TODO_HE}</p>
             <p><b>5.2 מתי מתחילה הספירה.</b> ספירת ימי האספקה מתחילה לאחר שההזמנה אושרה, התשלום הוסדר והמוצר זמין למשלוח — ולא בהכרח מרגע לחיצת ההזמנה. הזמנות הכוללות רכיבים שיש להזמין מספק תלויות בזמינות אצל הספק, והערכת זמן תימסר ללקוח מראש ככל הידוע.</p>
    ...
    },
    {
      ...
      html: `<p><b>6.1 שירותים שניתן לרכוש בעמוד התשלום.</b> לצד המוצרים ניתן להוסיף להזמנה שירותים מוגדרים, שמחירם מוצג לצדם: התקנת Windows (עם רישיון או ללקוח שיש רישיון) — <b>רק כאשר ההזמנה כוללת מחשב</b>; העברת נתונים/גיבוי; ניקוי פנימי והחלפת משחה תרמית; תמיכה מרחוק. כל שירות שנרכש מופיע כשורה נפרדת בקבלה.</p>
             <p><b>6.2 שירותים שאינם נרכשים דרך האתר.</b> שירותים הכרוכים בהגעה פיזית ובתיאום אישי — <b>ביקור בית, התקנת מחשב בעמדת הלקוח, אבחון תקלה ותיקון</b> — <b>אינם נמכרים דרך האתר</b>. יש לפנות דרך עמוד <a href="support.html">שירות ותמיכה</a>; המחיר נגזר מהמרחק ומהעבודה בפועל, ויאושר מול הלקוח <b>לפני</b> תחילת העבודה.</p>
    ...
    },
    {
      ...
      html: `<p><b>7.1 אחריות על מוצרים וחומרה — משתנה מוצר למוצר.</b> תקופת האחריות והגורם הנותן אותה <b>אינם אחידים</b> באתר: הם נשלפים מהספק/היבואן ומוצגים <b>בדף כל מוצר בנפרד</b>. <b>אין באתר הבטחה גורפת לתקופת אחריות אחידה לכל המוצרים.</b> מוצר שלא מוצגת לצדו אחריות — יש לברר את תנאיו מול בית העסק לפני הרכישה.</p>
             <p><b>7.2 רכיבים ושירות הרכבה — שני דברים נפרדים.</b> הרכיבים נמכרים ללקוח <b>כפי שהם</b>, במצבם ובאריזתם המקוריים מאת היצרן/היבואן, ללא כל שינוי, עיבוד או ייצור מצד בית העסק. <b>הלקוח הוא שבוחר את הרכיבים</b>, והוא רשאי לקבלם כמות שהם — ארוזים ולא מורכבים.</p>
             <p>״שירות הרכבת מחשב״ הוא <b>שירות נפרד</b> המוזמן לבקשת הלקוח עבור רכיבים שנרכשו במסגרת העסקה, בדיוק כפי שניתן להזמינו עבור רכיבים שנרכשו במקום אחר. השירות כולל הרכבה פיזית של הרכיבים, חיבורם, בדיקה בסיסית של תקינות ההרכבה והפעלת המערכת, בהתאם להיקף השירות שנרכש.</p>
    ...
    },
    {
      ...
      html: `<p><b>8.1 מוצר מוגמר — 14 יום.</b> לקוח שרכש מוצר מוגמר (מחשב מוכן, מחשב נייד, רכיב בודד או ציוד היקפי) רשאי לבטל את העסקה בתוך <b>14 ימים</b> מיום קבלת המוצר <b>או</b> מיום קבלת מסמך פרטי העסקה — <b>לפי המאוחר מביניהם</b>, בהתאם לסעיף 14ג לחוק הגנת הצרכן, תשמ״א-1981.</p>
             ...
             <p><b>8.3 דמי ביטול.</b> בביטול שאינו עקב פגם, אי-התאמה או הפרה, רשאי בית העסק לגבות דמי ביטול בשיעור <b>הנמוך מבין 5% ממחיר העסקה או 100 ₪</b>. החזרת המוצר תיעשה למקום עסקו של בית העסק או בתיאום אחר עמו, והמוצר יוחזר באריזתו המקורית ובמצב תקין. גביית עלות משלוח החזרה מעבר לדמי הביטול — ${LEGAL_TODO_HE}</p>
             ...
             <p><b>8.5 מוצר פגום או שאינו תואם להזמנה.</b> סופק מוצר פגום, או שאינו תואם את ההזמנה, או שלא סופק במועד — זכאי הלקוח לתיקון, החלפה, או ביטול העסקה וקבלת <b>מלוא כספו בחזרה ללא דמי ביטול</b>, בהתאם לחוק הגנת הצרכן ולחוק המכר, תשכ״ח-1968. <b>שום חריג בסעיף 8.6 אינו חל על מקרה של פגם.</b></p>
             <p><b>8.6 הרכבות מחשב בהתאמה אישית.</b> החוק מחריג מזכות הביטול ״טובין שיוצרו במיוחד בעבור הצרכן על פי מידות או דרישות מיוחדות״. <b>חריג זה אינו חל אוטומטית על כל מחשב</b>, ובוודאי לא על מחשב המורכב מרכיבים סטנדרטיים שנבחרו מהקטלוג; תחולתו תלויה בסוג המוצר ובשלב הייצור/ההרכבה. ${LEGAL_TODO_HE}</p>
    ...
    },
    {
      ...
      html: `<p><b>10.1 מה נאסף ולשם מה.</b> בית העסק אוסף ושומר פרטים שנמסרים על ידי הלקוח באופן יזום — שם, טלפון, דוא״ל, כתובת (לצורך משלוח או ביקור בית) ופרטי ההזמנה — לצורך ביצוע ההזמנה, מתן השירות, תיעוד, מעקב אחר קריאות שירות עתידיות ויצירת קשר בנוגע לאותה הזמנה.</p>
             <p><b>10.2 למי הוא מועבר.</b> הפרטים נשמרים במערכת ניהול לקוחות (CRM) פנימית של בית העסק ואינם נמכרים ואינם מועברים לצד שלישי לצורכי שיווק. העברה נעשית רק כנדרש לביצוע העסקה עצמה — חברת סליקה לצורך התשלום, חברת שילוח לצורך המשלוח, וספקים לצורך הזמנת המוצר — או כאשר הדבר נדרש לפי דין.</p>
             ...
             <p>מדיניות פרטיות מלאה ונפרדת, והיקף החובות החלות על בית העסק מכוח תיקון 13 — ${LEGAL_TODO_HE}</p>`
    },
    {
      title: "11. קטינים",
    ...
    {
      title: "12. נגישות",
      html: `<p>בית העסק רואה חשיבות במתן שירות שוויוני ונגיש.</p>
    ...
    },
    {
      ...
      html: `<p>על תקנון זה ועל כל עסקה שתבוצע באתר יחולו <b>דיני מדינת ישראל</b>.</p>
             <p>הצדדים יפעלו ליישוב מחלוקות בדרך של פנייה ישירה. <b>אין בתקנון זה כדי לגרוע מזכותו של צרכן לפנות לכל ערכאה מוסמכת לפי דין</b> או לממש כל זכות אחרת המוקנית לו. קביעת סמכות שיפוט ייחודית בחוזה מול צרכן — ${LEGAL_TODO_HE}</p>
  ...
  en: [
    {
      ...
      html: `<p>This website (the "Site") is operated by <b>Dvir Peretz</b>, an <b>exempt dealer (עוסק פטור)</b> under Israeli VAT law, business ID 322999582 ("DvirTech" or "the Business").</p>
             <p>The Business is an online business and <b>does not operate a physical walk-in store</b>. Self-pickup is available from <b>Even Shmuel</b>, by prior arrangement only. Technician visits are made in the Beer Sheva area, the Center, and the Shfela region, by prior appointment.</p>
             ...
             <p>Consumer Protection Law provisions apply to a "consumer" as defined in that law. A purchase made for business purposes may not be protected in the same way. ${LEGAL_TODO_EN}</p>`
    },
    {
    ...
    },
    {
      ...
      html: `<p>The Business is an <b>exempt dealer (עוסק פטור)</b> and does not charge VAT separately. Prices shown on the Site are the prices the customer is required to pay, unless expressly stated otherwise.</p>
    ...
    },
    {
      ...
      html: `<p><b>External secure processing.</b> Payment does not take place on the Site itself. On confirming the order, the customer is redirected to an <b>external secure payment page</b> operated by the payment processor (SUMIT/UPAY). <b>Credit card details do not pass through the Site, are not visible to the Business and are not stored by it</b> — they are entered and processed by the payment processor alone.</p>
             ...
             <p><b>4 installments or more — installment fee.</b> Choosing 4 or more installments is an optional choice by the customer and carries a fee reflecting the actual financing cost. The fee is calculated <b>per payment month</b> (so 6 installments cost more than 4), and is shown to the customer <b>as an exact shekel amount, together with the total payable, before</b> the transaction is confirmed — not after.</p>
             <p><b>No amount will be charged that was not displayed on screen before the transaction was confirmed.</b></p>
    ...
    },
    {
      ...
      html: `<p><b>5.1 Shipping.</b> Shipping is carried out by an external courier service, in two options selectable on the payment page: <b>standard delivery — ₪35, estimated 3-7 business days</b>; <b>express delivery — ₪49, estimated 2-5 business days</b>. The price and delivery time shown on the payment page at the time of ordering are the binding ones. The courier company's identity will be published on the Site. ${LEGAL_TODO_EN}</p>
             <p><b>5.2 When the clock starts.</b> Delivery-day counting begins after the order is confirmed, payment is settled and the product is available to ship — not necessarily from the moment the order button is pressed. Orders including parts that must be ordered from a supplier depend on supplier availability, and a time estimate will be given to the customer in advance as best known.</p>
    ...
    },
    {
      ...
      html: `<p><b>6.1 Services purchasable at checkout.</b> Alongside products, defined services may be added to an order, with their price shown next to them: Windows installation (with a license, or for a customer who has their own) — <b>only when the order includes a computer</b>; data transfer/backup; internal cleaning and thermal paste replacement; remote support. Each purchased service appears as a separate line on the receipt.</p>
             <p><b>6.2 Services not sold through the Site.</b> Services involving a physical visit and personal scheduling — <b>home visits, on-site computer setup, fault diagnosis and repair</b> — <b>are not sold through the Site</b>. Please use the <a href="support.html">Service &amp; Support</a> page; the price depends on distance and the actual work, and will be agreed with the customer <b>before</b> work begins.</p>
    ...
    },
    {
      ...
      html: `<p><b>8.1 Finished products — 14 days.</b> A customer who purchased a finished product (ready-made PC, laptop, single component or peripheral) may cancel within <b>14 days</b> of receiving the product <b>or</b> of receiving the transaction details document — <b>whichever is later</b> — under Section 14C of the Consumer Protection Law, 1981.</p>
             ...
             <p><b>8.3 Cancellation fee.</b> For a cancellation not due to a defect, non-conformity or breach, the Business may charge a cancellation fee of <b>the lower of 5% of the transaction price or ₪100</b>. The product is returned to the Business's place of business, or as otherwise arranged with it, in its original packaging and in working condition. Charging return-shipping cost on top of the cancellation fee — ${LEGAL_TODO_EN}</p>
    ...
    },
    {
      ...
      html: `<p><b>10.1 What is collected and why.</b> The Business collects and stores details voluntarily provided by the customer — name, phone, email, address (for shipping or a home visit) and order details — in order to fulfil the order, provide the service, keep records, follow up on future service calls, and communicate regarding that order.</p>
             <p><b>10.2 Who it is shared with.</b> Details are stored in the Business's internal CRM system and are not sold and not shared with third parties for marketing. Sharing occurs only as required to carry out the transaction itself — the payment processor for payment, the courier for shipping, and suppliers for ordering the product — or where required by law.</p>
             ...
             <p>A full, separate privacy policy, and the scope of the obligations that Amendment 13 imposes on the Business — ${LEGAL_TODO_EN}</p>`
    },
    {
      title: "11. Minors",
    ...
    },
    {
      ...
      html: `<p>The Business considers equal, accessible service important.</p>
    ...
    },
    {
      ...
      html: `<p>These Terms and any transaction made on the Site are governed by <b>the laws of the State of Israel</b>.</p>
             <p>The parties will seek to resolve disputes by direct contact. <b>Nothing in these Terms derogates from a consumer's right to approach any competent forum under law</b> or to exercise any other right granted to them. Setting an exclusive jurisdiction clause in a consumer contract — ${LEGAL_TODO_EN}</p>
