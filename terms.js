...
const TERMS_SECTIONS = {
  ...
  he: [
    ...
    },
    {
      ...
      html: `<p><b>5.1 משלוח.</b> המשלוח מתבצע באמצעות <b>חברת שילוח חיצונית</b>, בשתי אפשרויות הנבחרות בעמוד התשלום: <b>משלוח רגיל — 29 ₪, טווח משוער 3-7 ימי עסקים</b>; <b>משלוח מהיר — 59 ₪, טווח משוער 2-5 ימי עסקים</b>. המחיר וזמן האספקה המוצגים בעמוד התשלום במועד ביצוע ההזמנה הם המחייבים.</p>
             <p><b>5.1א זמינות מלאי וזמני אספקה.</b> המוצרים מסופקים לבית העסק על ידי ספקים ויבואנים. <b>טווחי האספקה המוצגים באתר הם הערכה</b> ואינם התחייבות למועד מדויק. ככל שמוצר שהוזמן יימצא חסר אצל הספק לאחר ביצוע ההזמנה, או ככל שהוא מסומן באתר בזמינות מלאי נמוכה, ייתכן שזמן האספקה יהיה ארוך מהמצוין — ובית העסק יעדכן את הלקוח ויציע להמתין, להחליף את הפריט או לבטל את ההזמנה ולקבל החזר מלא בגינו. <b>אין באמור כדי לגרוע מזכויות הלקוח לפי דין</b>, לרבות לפי חוק הגנת הצרכן, תשמ״א-1981 ותקנותיו.</p>
    ...
    },
    {
      ...
      html: `<p><b>7.1 אחריות על מוצרים וחומרה — משתנה מוצר למוצר.</b> תקופת האחריות והגורם הנותן אותה <b>אינם אחידים</b> באתר: הם נשלפים מהספק/היבואן ומוצגים <b>בדף כל מוצר בנפרד</b>. <b>אין באתר הבטחה גורפת לתקופת אחריות אחידה לכל המוצרים.</b> מוצר שלא מוצגת לצדו אחריות — יש לברר את תנאיו מול בית העסק לפני הרכישה.</p>
             ...
             <ul>
               <li><b>תקופת אחריות</b> (למשל "שנה אחת", "שנתיים", "3 שנים") — אחריות יצרן/יבואן לתקופה הנקובה, אצל נותן האחריות המצוין לצדה.</li>
               <li><b>"שנה עד 3 שנים (לפי דגם/מספר סידורי)"</b> — תקופת האחריות נקבעת אצל היצרן לפי הדגם והמספר הסידורי של היחידה שסופקה. אפשר לברר את התקופה המדויקת מול בית העסק לפני הרכישה או מול היצרן לאחריה.</li>
               <li><b>"(On-Site)"</b> — שירות האחריות ניתן במיקום הלקוח, בהתאם לתנאי נותן האחריות.</li>
               <li><b>"תקינות בהגעה (DOA)"</b> — פריט שאינו נושא אחריות יצרן לתקופה. <b>הבדיקה היא לתקינות המוצר בעת קבלתו</b>: אם הפריט הגיע פגום או שאינו פועל, יש להודיע לבית העסק סמוך לקבלתו והוא יוחלף או שתוחזר תמורתו. נוסח זה מופיע בעיקר על אביזרים נלווים כגון כבלים, פאנלים וזכוכיות מארז. <b>אין בכך כדי לגרוע מזכויות הלקוח לפי דין</b>, לרבות לפי חוק הגנת הצרכן, תשמ״א-1981 ותקנותיו ולפי דיני המכר.</li>
             </ul>
             <p>לצד כל נוסח מצוין <b>נותן האחריות</b> — היצרן, היבואן הרשמי או מעבדת השירות מטעמו. בית העסק אינו נותן האחריות במקרים אלה, ותפקידו למסור ללקוח את המוצר ואת מסמכי האחריות שצורפו לו ולסייע בהתנהלות מול גורם השירות, כאמור בסעיף 7.3.</p>`
    },
    {
